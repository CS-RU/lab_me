...
mov byte [es:0], '6'   ; Write an '6'
mov byte [es:1], 0x2D

mov byte [es:2], '6'   ; Write an '6'
mov byte [es:3], 0x64    
...
mov byte [es:8], '0'   ; Write an '0'
mov byte [es:9], 0xF4

mov byte [es:10], '0'   ; Write an '0'
mov byte [es:11], 0xD5

mov byte [es:12], '5'   ; Write an '5'
mov byte [es:13], 0xA0

mov byte [es:14], '3'   ; Write an '3'
mov byte [es:15], 0x13

mov byte [es:16], '4'   ; Write an '4'
mov byte [es:17], 0xE3

mov byte [es:18], '4'   ; Write an '4'
mov byte [es:19], 0x16
